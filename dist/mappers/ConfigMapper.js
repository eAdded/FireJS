...
class default_1 {
    ...
    getConfig(userConfig = undefined) {
        ...
        config.paths.template = config.paths.template ? this.makeAbsolute(config.paths.root, config.paths.template) : path_1.resolve(config.paths.root, "web/template.html");
